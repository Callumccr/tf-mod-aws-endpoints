...
resource "aws_vpc_endpoint_route_table_association" "private_s3" {
  count = var.enabled && var.enable_s3_endpoint ? length(var.private_route_table_ids) : 0
...
resource "aws_vpc_endpoint_route_table_association" "public_s3" {
  count = var.enabled && var.enable_s3_endpoint ? length(var.public_route_table_ids) : 0
...
resource "aws_vpc_endpoint_route_table_association" "private_dynamodb" {
  count = var.enabled && var.enable_dynamodb_endpoint ? length(var.private_route_table_ids) : 0
...
resource "aws_vpc_endpoint_route_table_association" "public_dynamodb" {
  count = var.enabled && var.enable_dynamodb_endpoint ? length(var.public_route_table_ids) : 0
...
resource "aws_vpc_endpoint" "codebuild" {
  ...
  subnet_ids          = coalescelist(var.codebuild_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "codecommit" {
  ...
  subnet_ids          = coalescelist(var.codecommit_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "git_codecommit" {
  ...
  subnet_ids          = coalescelist(var.git_codecommit_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "config" {
  ...
  subnet_ids          = coalescelist(var.config_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "sqs" {
  ...
  subnet_ids          = coalescelist(var.sqs_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "secretsmanager" {
  ...
  subnet_ids          = coalescelist(var.secretsmanager_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "ssm" {
  ...
  subnet_ids          = coalescelist(var.ssm_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "ssmmessages" {
  ...
  subnet_ids          = coalescelist(var.ssmmessages_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "ec2" {
  ...
  subnet_ids          = coalescelist(var.ec2_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "ec2messages" {
  ...
  subnet_ids          = coalescelist(var.ec2messages_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "transferserver" {
  ...
  subnet_ids          = coalescelist(var.transferserver_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "ecr_api" {
  ...
  subnet_ids          = coalescelist(var.ecr_api_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "ecr_dkr" {
  ...
  subnet_ids          = coalescelist(var.ecr_dkr_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "apigw" {
  ...
  subnet_ids          = coalescelist(var.apigw_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "kms" {
  ...
  subnet_ids          = coalescelist(var.kms_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "ecs" {
  ...
  subnet_ids          = coalescelist(var.ecs_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "ecs_agent" {
  ...
  subnet_ids          = coalescelist(var.ecs_agent_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "ecs_telemetry" {
  ...
  subnet_ids          = coalescelist(var.ecs_telemetry_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "sns" {
  ...
  subnet_ids          = coalescelist(var.sns_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "monitoring" {
  ...
  subnet_ids          = coalescelist(var.monitoring_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "logs" {
  ...
  subnet_ids          = coalescelist(var.logs_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "events" {
  ...
  subnet_ids          = coalescelist(var.events_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "elasticloadbalancing" {
  ...
  subnet_ids          = coalescelist(var.elasticloadbalancing_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "cloudtrail" {
  ...
  subnet_ids          = coalescelist(var.cloudtrail_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "kinesis_streams" {
  ...
  subnet_ids          = coalescelist(var.kinesis_streams_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "kinesis_firehose" {
  ...
  subnet_ids          = coalescelist(var.kinesis_firehose_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "glue" {
  ...
  subnet_ids          = coalescelist(var.glue_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "sagemaker_notebook" {
  ...
  subnet_ids          = coalescelist(var.sagemaker_notebook_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "sts" {
  ...
  subnet_ids          = coalescelist(var.sts_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "cloudformation" {
  ...
  subnet_ids          = coalescelist(var.cloudformation_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "codepipeline" {
  ...
  subnet_ids          = coalescelist(var.codepipeline_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "appmesh_envoy_management" {
  ...
  subnet_ids          = coalescelist(var.appmesh_envoy_management_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "servicecatalog" {
  ...
  subnet_ids          = coalescelist(var.servicecatalog_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "storagegateway" {
  ...
  subnet_ids          = coalescelist(var.storagegateway_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "transfer" {
  ...
  subnet_ids          = coalescelist(var.transfer_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "sagemaker_api" {
  ...
  subnet_ids          = coalescelist(var.sagemaker_api_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "sagemaker_runtime" {
  ...
  subnet_ids          = coalescelist(var.sagemaker_runtime_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
data "aws_vpc_endpoint_service" "appstream" {
  count = var.enabled && var.enable_appstream_endpoint ? 1 : 0
...
resource "aws_vpc_endpoint" "appstream" {
  ...
  subnet_ids          = coalescelist(var.appstream_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
  ...
  tags = merge(
    module.label.tags,
    {
      "Name" = format(
        ...
        module.label.id,
        var.delimiter,
        data.aws_vpc_endpoint_service.appstream[0].service_name
      )
    }
  )
}
...
resource "aws_vpc_endpoint" "athena" {
  ...
  subnet_ids          = coalescelist(var.athena_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "rekognition" {
  ...
  subnet_ids          = coalescelist(var.rekognition_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "efs" {
  ...
  subnet_ids          = coalescelist(var.efs_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
...
resource "aws_vpc_endpoint" "cloud_directory" {
  ...
  subnet_ids          = coalescelist(var.cloud_directory_endpoint_subnet_ids, var.public_subnet_ids, var.private_subnet_ids)
